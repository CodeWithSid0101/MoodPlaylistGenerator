...
window.approvalHandler = function(userId, approved) {
    const adminApp = document.app || {};
    if (adminApp.handleApproval) {
        adminApp.handleApproval(userId, approved);
    }
};

window.logoutHandler = function() {
    const adminApp = document.app || {};
    if (adminApp.handleLogout) {
